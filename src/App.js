...
class App extends React.Component {
  ...
  handleSubmit() {
    ...
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/base/consultarRegistros',
      {
        method: "get"
  ...
  obtRegistro() {
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/base/consultarRegistro', {
      method: "post",
      body: JSON.stringify({
  ...
  eliminarRegistro() {
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/base/eliminarRegistro', {
      method: "post",
      body: JSON.stringify({
        id: this.state.registro
      }),
  ...
  crearRegistro() {
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/base/crearRegistro', {
      method: "post",
      body: JSON.stringify({
  ...
  predecir() {
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/modelo/prediccion', {
      method: "post",
      body: JSON.stringify({
        embarazos: this.state.embarazos,
        glucosa: this.state.glucosa,
  ...
  entrenarModelo() {
    //console.log("HOLA");
    fetch('http://107.21.18.170:8080/modelo/reentrenar', {
      method: "post",
      body: JSON.stringify({
        id: this.state.registro
      }),
        ...
        <div className="card">
          ...
          <div className="row">
            ...
            <div className="column">
              ...
              <div>
                <label for="resultado2">¿Diabético? </label>
